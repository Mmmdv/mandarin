...
import { Animated, FlatList, LayoutAnimation, NativeScrollEvent, NativeSyntheticEvent, Pressable, View } from 'react-native';
...
export default function WeightTracker() {
    ...
    const currentThemeColor = comp?.color || '#10B981';
