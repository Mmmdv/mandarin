...
const NotificationsPage = () => {
  ...
  const themedModalStyles = React.useMemo(
    () => getModalStyles(colors),
    [colors],
  );
      ...
      result = result.filter((n) => {
        if (selectedStatus === "Ləğv olunub") {
          return (
            ...
            n.status === "Dəyişdirilib və ləğv olunub"
          );
        }
      ...
      return (
        ...
        >
          <View style={{ width: 32, alignItems: "center" }}>
            {item.categoryIcon &&
            !Ionicons.glyphMap[
              item.categoryIcon as keyof typeof Ionicons.glyphMap
            ] ? (
              ...
              <Ionicons
                name={(item.categoryIcon as any) || "notifications-outline"}
                size={26}
                color={statusColor}
              />
            )}
          ...
          <View style={styles.contentContainer}>
            ...
            <StyledText
              style={[
                styles.itemDate,
                { color: isDark ? "#c2c1c1ff" : colors.PLACEHOLDER },
              ]}
            >
            ...
            >
              ...
              <StyledText
                style={{ fontSize: 10, color: statusColor, fontWeight: "600" }}
              >
                {statusLabel}
              </StyledText>
            </View>
