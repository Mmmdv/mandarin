    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          type: "boolean",
          onReset: () =>
            dispatch(updateAppSetting({ movieNotifications: true })),
        },
        {
          ...
          type: "boolean",
          onReset: () =>
            dispatch(updateAppSetting({ shoppingNotifications: true })),
        },
        {
          ...
          type: "boolean",
          onReset: () =>
            dispatch(updateAppSetting({ eventsNotifications: true })),
        },
        {
          ...
          type: "boolean",
          onReset: () =>
            dispatch(updateAppSetting({ expensesNotifications: true })),
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          value: (() => {
            ...
            if (days > 0)
              return `${days} ${t("days_short")} ${hours % 24} ${t("hours_short")}`;
            if (hours > 0)
              return `${hours} ${t("hours_short")} ${minutes % 60} ${t("minutes_short")}`;
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          key: "mood_count",
          label: "Mood qeydləri",
          value: Object.values(todayState.daily || {}).filter(
            (d) => d.mood !== undefined,
          ).length,
          icon: "happy-outline",
          type: "number",
    ...
    },
    {
      ...
      items: [
        ...
        ...notificationState.notifications.map((n) => ({
          ...
          icon: (n.read
            ? "mail-open-outline"
            : "mail-unread-outline") as keyof typeof Ionicons.glyphMap,
          type: "string" as const,
        })),
      ],
    },
      ...
      >
        ...
        >
          ...
          >
            <View style={styles.summaryRow}>
              <View style={styles.summaryItem}>
                ...
                <StyledText
                  style={[styles.summaryValue, { color: colors.PRIMARY_TEXT }]}
                >
                  {groups.reduce((acc, g) => acc + g.items.length, 0)}
                </StyledText>
                <StyledText
                  style={[styles.summaryLabel, { color: colors.SECTION_TEXT }]}
                >
                  Ümumi sahə
                </StyledText>
              </View>
            ...
            <View key={group.groupKey} style={styles.groupContainer}>
              ...
              >
                <View style={styles.groupHeaderLeft}>
                  <StyledText
                    style={[styles.groupTitle, { color: colors.PRIMARY_TEXT }]}
                  >
                  ...
                  <View
                    style={[
                      styles.countBadge,
                      { backgroundColor: isDark ? "#2a2f3a" : "#e0e5ee" },
                    ]}
                  >
                    <StyledText
                      style={[
                    ...
                    >
                      ...
                      {item.onReset && (
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            confirmReset(item.label, item.onReset!)
                          }
                          activeOpacity={0.6}
          ...
          <View
            style={[
              styles.dangerZone,
              { borderColor: isDark ? "#1a365d" : "#bfdbfe", marginBottom: 16 },
            ]}
          >
              ...
              {[
                ...
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    borderColor: "#3b82f6",
                    backgroundColor:
                      mockPeriod === option.days ? "#3b82f6" : "transparent",
                  }}
                  onPress={() => setMockPeriod(option.days)}
                >
                  <StyledText
                    style={{
                      color: mockPeriod === option.days ? "#fff" : "#3b82f6",
                      fontSize: 13,
                      fontWeight: "600",
                    }}
                  >
            ...
            >
              ...
              <StyledText
                style={[styles.dangerButtonText, { color: "#3b82f6" }]}
              >
          ...
          <View
            style={[
              styles.dangerZone,
              { borderColor: isDark ? "#3b1a1a" : "#fecaca" },
            ]}
          >
            ...
            <TouchableOpacity
              style={[
                styles.dangerButton,
                { backgroundColor: isDark ? "#1c1014" : "#fff5f5" },
              ]}
              onPress={() =>
                confirmReset("Bütün bildirişlər", () =>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                confirmReset("Tətbiqi tam sıfırla", () =>
