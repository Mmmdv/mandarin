...
const ApplicationSection: React.FC = () => {
  ...
  const handleCloseSuccess = () => {
    ...
    setTimeout(async () => {
      try {
        // During development, DevSettings.reload() is more reliable for restarting the JS bundle
        if (__DEV__) {
          DevSettings.reload();
          return;
        }

        // In production/standalone builds, use Updates for reload
        ...
        <View style={styles.aboutContainer}>
          <View style={styles.aboutRow}>
            ...
            >
              ...
              />
              <View>
                <StyledText style={[styles.aboutLabel, { fontWeight: "600" }]}>
                  {t("version")}
                </StyledText>
                <StyledText style={{ fontSize: 13, color: colors.PLACEHOLDER }}>
                  v{appVersion}
                </StyledText>
              </View>
            </View>
          </View>
          <TouchableOpacity style={styles.aboutRow} onPress={handleRateUs}>
            <View
