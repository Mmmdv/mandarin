...
export default function BreathingExercise() {
  ...
  }, [selectedDuration, dispatch, completionAnim]);
  ...
  }, [dispatch, selectedDuration, completionAnim]);
  ...
  }, [isSeaEnabled, isActive, seaPlayer]);
  ...
  }, [phase, isSoundEnabled, isActive, whooshPlayer]);

  const triggerTextTransition = useCallback(() => {
    Animated.sequence([
  ...
  }, [phase, isActive, animatedOpacity, animatedScale]);
  ...
  }, [countdown, completionAnim, messages, selectedDuration]);
  ...
  const getPhaseText = () => {
    switch (phase) {
      case "inhale":
        return t("breathing_inhale");
      case "hold":
        return t("breathing_hold");
      case "exhale":
        return t("breathing_exhale");
      default:
        return "";
    }
  };
  ...
  if (isCompleted) {
    return (
      <View style={[styles.container, { width: containerWidth }]}>
        <Animated.View
          style={[styles.completionScreen, { opacity: completionAnim }]}
        >
          <Ionicons
            name="sunny"
            size={80}
          ...
          />
          <StyledText style={styles.completionTitle}>
            {t("breathing_completed_title")}
          </StyledText>
          <StyledText style={styles.completionSubTitle}>
            {t("breathing_completed_subtitle")}
          </StyledText>

          <TouchableOpacity
            style={[
              styles.startButton,
              { backgroundColor: COLORS_THEME.primary, marginTop: 40 },
            ]}
            onPress={handleStop}
          >
            <Ionicons name="refresh" size={24} color="#FFF" />
            <StyledText style={styles.buttonText}>
              {t("breathing_button_restart")}
            </StyledText>
          </TouchableOpacity>
          ...
          >
            <Ionicons
              name={
                reminderScheduled ? "checkmark-circle" : "notifications-outline"
              }
              size={20}
    ...
    <View style={[styles.container, { width: containerWidth }]}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.statusTextContainer}>
          {countdown !== null ? (
            <StyledText style={styles.countdownText}>
              {t("breathing_get_ready")}: {countdown}
            </StyledText>
          ) : !isActive ? (
                ...
                >
                  <StyledText
                    style={[
                      styles.phaseText,
                      {
                        fontSize: animationSize * 0.1,
                        color: isDark ? COLORS_THEME.text : colors.PRIMARY_TEXT,
                      },
                    ]}
                  >
                    {getPhaseText()}
                  ...
                  <StyledText
                    style={[
                      styles.phaseCounterText,
                      {
                        fontSize: animationSize * 0.15,
                        color: COLORS_THEME.primary,
                      },
                    ]}
                  >
                    {phaseTimeLeft}
                    <StyledText style={{ fontSize: animationSize * 0.05 }}>
                      s
                    </StyledText>
                  </StyledText>
                </Animated.View>
        ...
        <View style={styles.actionButtonContainer}>
          {!isActive && countdown === null ? (
            ...
            >
              ...
              <StyledText
                style={[styles.buttonText, { color: COLORS_THEME.primary }]}
              >
            ...
            <View style={{ alignItems: "center", gap: 12, marginTop: -30 }}>
              <StyledText
                style={{
                  color: isDark ? COLORS_THEME.textMuted : colors.SECTION_TEXT,
                  fontSize: 16,
                  fontWeight: "500",
                }}
              >
              ...
              <TouchableOpacity
                style={[
                  styles.stopButton,
                  { borderColor: COLORS_THEME.primary, borderStyle: "dashed" },
                ]}
                onPress={handleStop}
              >
                <Ionicons
