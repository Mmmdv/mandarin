...
type AddBirthdayModalProps = {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (name: string, date: string, phone?: string) => void;
};
...
const AddBirthdayModal: React.FC<AddBirthdayModalProps> = ({
  ...
  const onPressAdd = () => {
    ...
    onAdd(name.trim(), date!.toISOString(), phone.trim() || undefined);
    onClose();
  };
        ...
        <View style={viewStyles.container}>
          ...
          >
            <View style={viewStyles.tableContainer}>
              ...
              >
                <View style={viewStyles.tableLabelColumn}>
                  ...
                  />
                  <StyledText style={viewStyles.tableLabelText}>
                    {t("birthday_name")} *
                  </StyledText>
                </View>
                <View style={viewStyles.tableValueColumn}>
                  <TextInput
                    ref={inputRef}
                    style={[viewStyles.tableValueText, addStyles.inputInline]}
            ...
            >
              <Ionicons
                ...
                size={18}
                color={
                  contactSelected ? colors.SECTION_TEXT : colors.SECTION_TEXT
                }
              />
            ...
            {Platform.OS === "ios" && (
              ...
              >
                <View style={viewStyles.container}>
                  ...
                  />
                  <View
                    style={[modalStyles.buttonsContainer, { marginTop: 20 }]}
                  >
                    <StyledButton
                      label={t("save")}
                      onPress={() => {
          ...
          <View
            style={[
              ...
              addStyles.buttonsContainerMargin,
            ]}
          >
            <StyledButton
              label={t("cancel")}
