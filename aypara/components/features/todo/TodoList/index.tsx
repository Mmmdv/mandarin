...
const TodoList: React.FC<TodoListProps> = ({
  ...
  }, [pendingTodos.length, todoAnimation]);
  ...
  }, [completedTodos.length, doneAnimation]);
  ...
  }, [archivedTodos.length, archiveAnimation]);
  ...
  const sortedPendingTodos = sortTodos(
    pendingTodos,
    todoSortBy,
    todoSortOrder,
    lang,
  ...
  const sortedCompletedTodos = sortTodos(
    completedTodos,
    doneSortBy,
    doneSortOrder,
    lang,
  ...
  const sortedArchivedTodos = sortTodos(
    archivedTodos,
    archiveSortBy,
    archiveSortOrder,
    lang,
      ...
      <View style={{ flex: 1 }}>
        <View style={[styles.header, { zIndex: 10 }]}>
          ...
          <View
            ...
            pointerEvents="none"
          >
            <StyledText style={styles.greeting}>{t("tab_todo")}</StyledText>
          </View>
    ...
    <View style={{ flex: 1, overflow: "hidden" }}>
        ...
        >
          <View
            style={[
              ...
              sortedPendingTodos.length === 0 && { opacity: 0.5 },
              { zIndex: 2 },
            ]}
          >
            <View
            ...
            <StyledText
              style={[styles.sectionTitleCard, { color: colors.SECTION_TEXT }]}
            >
              {t("todo")}
            </StyledText>
            <View
            ...
            >
              <StyledText
                style={[styles.cardBadgeText, { color: colors.SECTION_TEXT }]}
              >
          ...
          <View style={[styles.sectionControls, { zIndex: 2 }]}>
            ...
            <View style={styles.sortZone}>
              {todoExpanded && sortedPendingTodos.length > 0 && (
                <SortControls
                  ...
                  onToggleSortBy={() =>
                    setTodoSortBy((prev) => (prev === "date" ? "text" : "date"))
                  }
                  onToggleSortOrder={() =>
                    setTodoSortOrder((prev) =>
                      prev === "asc" ? "desc" : "asc",
                    )
                  }
                />
            ...
            <View style={styles.chevronZone}>
              <Animated.View
                style={{ transform: [{ rotate: getRotation(todoAnimation) }] }}
              >
                <Ionicons
          ...
          <Animated.View
            style={[
              ...
              getCircleTransform(todoAnimation),
            ]}
          />
        </TouchableOpacity>
      )}
      ...
      {(doneExpanded || archiveExpanded) && (
        ...
        >
          <View
            style={[
              styles.sectionTitleContainer,
              sortedCompletedTodos.length === 0 && { opacity: 0.5 },
              { zIndex: 2 },
            ]}
          >
            <View
          ...
          <View style={[styles.sectionControls, { zIndex: 2 }]}>
            ...
            <View style={styles.sortZone}>
              {doneExpanded && sortedCompletedTodos.length > 0 && (
                <SortControls
                  ...
                  onToggleSortBy={() =>
                    setDoneSortBy((prev) => (prev === "date" ? "text" : "date"))
                  }
                  onToggleSortOrder={() =>
                    setDoneSortOrder((prev) =>
                      prev === "asc" ? "desc" : "asc",
                    )
                  }
                />
            ...
            <View style={styles.chevronZone}>
              <Animated.View
                style={{ transform: [{ rotate: getRotation(doneAnimation) }] }}
              >
                <Ionicons
                  name="chevron-forward"
                  size={14}
          ...
          <Animated.View
            style={[
              ...
              getCircleTransform(doneAnimation),
            ]}
          />
        </TouchableOpacity>
      )}
      ...
      {archiveExpanded && (
        <TouchableOpacity
          ...
          onPress={() =>
            toggleSection(setArchiveExpanded, archiveAnimation, "archive")
          }
        ...
        >
          <View
            style={[
              styles.sectionTitleContainer,
              sortedArchivedTodos.length === 0 && { opacity: 0.5 },
              { zIndex: 2 },
            ]}
          >
            <View
          ...
          <View style={[styles.sectionControls, { zIndex: 2 }]}>
            ...
            <View style={styles.sortZone}>
              {sortedArchivedTodos.length > 0 && (
                <SortControls
                  ...
                  onToggleSortBy={() =>
                    setArchiveSortBy((prev) =>
                      prev === "date" ? "text" : "date",
                    )
                  }
                  onToggleSortOrder={() =>
                    setArchiveSortOrder((prev) =>
                      prev === "asc" ? "desc" : "asc",
                    )
                  }
                />
            ...
            <View style={styles.chevronZone}>
              <Animated.View
                style={{
                  transform: [{ rotate: getRotation(archiveAnimation) }],
                }}
              >
                <Ionicons
                  name="chevron-forward"
          ...
          <Animated.View
            style={[
              ...
              getCircleTransform(archiveAnimation),
            ]}
          />
        </TouchableOpacity>
      )}
          ...
          <View style={styles.sectionContainer}>
            {!todoExpanded && (
              <TouchableOpacity
                ...
                onPress={() =>
                  toggleSection(setTodoExpanded, todoAnimation, "todo")
                }
                disabled={sortedPendingTodos.length === 0}
              >
                <View
                ...
                <View style={[styles.sectionControls, { zIndex: 2 }]}>
                  ...
                  <View style={styles.chevronZone}>
                    <Animated.View
                      style={{
                        transform: [{ rotate: getRotation(todoAnimation) }],
                      }}
                    >
                      <Ionicons
                        name="chevron-forward"
          ...
          <View style={styles.sectionContainer}>
            {!doneExpanded && (
              <TouchableOpacity
                ...
                onPress={() =>
                  toggleSection(setDoneExpanded, doneAnimation, "done")
                }
                disabled={sortedCompletedTodos.length === 0}
              >
                <View
                ...
                <View style={[styles.sectionControls, { zIndex: 2 }]}>
                  ...
                  <View style={styles.chevronZone}>
                    <Animated.View
                      style={{
                        transform: [{ rotate: getRotation(doneAnimation) }],
                      }}
                    >
                      <Ionicons
                        name="chevron-forward"
