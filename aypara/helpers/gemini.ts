          ...
          parts: [
            {
              text: `You are an expert multilingual task extractor. Listen to the audio and extract the task.
                            ...
                            3. **DATE CALCULATION**: Use the CURRENT LOCAL TIME provided above to calculate relative dates. Return a local ISO 8601 string for the "date" field WITHOUT the 'Z' at the end (e.g. YYYY-MM-DDTHH:mm:ss).
                            ...
                            - User: "Axşam evə gələndə çörək al" 
                              Result: {"title": "çörək al", "date": "2026-02-16T19:00:00"}
                            - User: "Sabah saat 10-da iclas var" 
                              Result: {"title": "iclas var", "date": "2026-02-17T10:00:00"}`,
            },
            {
              inline_data: {
                mime_type: "audio/m4a",
